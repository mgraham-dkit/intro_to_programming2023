...
# By including reversed() around the range, it will run the range values
# backwards instead of forwards, starting at 50 and descending through the values
for i in reversed(range(10, 51, 2)):
